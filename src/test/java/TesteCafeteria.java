...
public class TesteCafeteria {
    private final FabricaCafe cafeteria = FabricaCafe.getInstance(null);
    ...
    public void testCafeteriaCafeNormal() 
    {
        ...
        Cafe cafe = cafeteria.criarCafe("CafeNormal");
    ...
    public void testCafeteriaCafeCappuccino() 
    {
        ...
        Cafe cafe = cafeteria.criarCafe("CafeCappuccino");
    ...
    public void testCafeteriaCafeDescafeinado() 
    {
        ...
        Cafe cafe = cafeteria.criarCafe("CafeDescafeinado");
